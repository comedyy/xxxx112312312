...
namespace LiteNetLib
{
 ...
 totalPackets: {totalPackets}");
        ...
        static int[] AllPackageSize = new int[(int)PacketProperty.Empty];
        static int[] AllPackageCount = new int[(int)PacketProperty.Empty];
        ...
        internal void ProcessPacket(NetPacket packet)
        {
            ...
            AllPackageSize[(int)packet.Property] += packet.Size;
            AllPackageCount[(int)packet.Property] ++;
