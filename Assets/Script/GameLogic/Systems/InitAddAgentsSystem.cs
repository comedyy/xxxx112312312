...
public partial class InitAddAgentsSystem : SystemBase
{
    protected override void OnStartRunning()
    {
        ...
        {
            var agentId = MSPathSystem.AddAgentCS(0, i, 1, 3, 5, fp._0_05, fp._0_05, 1, 5, 1, 0, 0, i);
            var entity = EntityManager.CreateEntity(typeof(RvoComponent), typeof(LTransformComponent));
